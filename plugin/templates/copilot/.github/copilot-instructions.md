...
Before generating ANY Playwright or Cypress code, you MUST:

1. **Check the user's installed version:**

   ```bash
   npx playwright --version    # For Playwright
   npx cypress --version       # For Cypress
   ```

2. **Fetch the official docs for that version's API:**
   | Framework | Key Documentation Pages |
   |-----------|------------------------|
   | Playwright | [Writing Tests](https://playwright.dev/docs/writing-tests), [Locators](https://playwright.dev/docs/locators), [Fixtures](https://playwright.dev/docs/test-fixtures), [Configuration](https://playwright.dev/docs/test-configuration), [Best Practices](https://playwright.dev/docs/best-practices) |
   | Cypress | [Writing Tests](https://docs.cypress.io/guides/getting-started/writing-your-first-test), [Selecting Elements](https://docs.cypress.io/guides/core-concepts/interacting-with-elements), [Assertions](https://docs.cypress.io/guides/references/assertions), [Commands](https://docs.cypress.io/api/table-of-contents), [Configuration](https://docs.cypress.io/guides/references/configuration) |

3. **Adapt your output** to match the installed version's API. Never assume the latest version.
