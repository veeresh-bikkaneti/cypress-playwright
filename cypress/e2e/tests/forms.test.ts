...
describe("Form Testing - Input Interactions", () => {
  ...
  describe("cy.type() - Text Input", () => {
    ...
    /**
     * Type keyboard shortcuts (headless compatible)
     */
  ...
  describe("cy.select() - Dropdown Selection", () => {
    ...
    it("should select option by value", () => {
      cy.getByTestId("country-select").select("us").should("have.value", "us");
    });
  ...
  describe("cy.check() / cy.uncheck() - Checkboxes", () => {
    ...
    it("should check a checkbox", () => {
      cy.getByTestId("interest-technology").check().should("be.checked");
    });
  ...
  describe("Radio Buttons", () => {
    ...
    it("should select radio button", () => {
      cy.getByTestId("gender-male").check().should("be.checked");
  ...
  describe("cy.focus() / cy.blur() - Focus Management", () => {
    ...
    it("should focus on input element", () => {
      cy.getByTestId("fullname-input").focus().should("be.focused");
    });
    ...
    it("should blur focused element", () => {
      cy.getByTestId("fullname-input").focus().blur().should("not.be.focused");
    });
    ...
    it("should trigger validation on blur", () => {
      ...
      cy.getByTestId("email-input").type("invalid-email").blur();
  ...
  describe("Number & Range Inputs", () => {
    ...
    it("should handle number input", () => {
      cy.getByTestId("age-input").type("25").should("have.value", "25");
    });
