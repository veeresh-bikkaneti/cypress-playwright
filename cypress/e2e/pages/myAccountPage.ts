...
class MyAccountPage {
  ...
  get sidebarNav() {
    return cy.get('[data-testid="sidebar-nav"]');
  }
  get navOverview() {
    return cy.get('[data-testid="nav-overview"]');
  }
  get navOrders() {
    return cy.get('[data-testid="nav-orders"]');
  }
  get navProducts() {
    return cy.get('[data-testid="nav-products"]');
  }
  get navSettings() {
    return cy.get('[data-testid="nav-settings"]');
  }
  get logoutLink() {
  ...
  // Orders section
  get ordersSection() {
    return cy.get('[data-testid="orders-section"]');
  }
  get ordersTable() {
    return cy.get('[data-testid="orders-table"]');
  }
  get createOrderBtn() {
    return cy.get('[data-testid="create-order-btn"]');
  }

  // Storage section
  get storageSection() {
    return cy.get('[data-testid="storage-section"]');
  }
  get setCookieBtn() {
    return cy.get('[data-testid="set-cookie-btn"]');
  }
  get getCookieBtn() {
    return cy.get('[data-testid="get-cookie-btn"]');
  }
  get clearCookiesBtn() {
    return cy.get('[data-testid="clear-cookies-btn"]');
  }
  get setStorageBtn() {
    return cy.get('[data-testid="set-storage-btn"]');
  }
  get clearStorageBtn() {
    return cy.get('[data-testid="clear-storage-btn"]');
  }
  get storageResult() {
    return cy.get('[data-testid="storage-result"]');
  }
