...
-   **[NEW]** Session Caching (`cy.session`)
-   **[NEW]** Cross-Origin Testing (`cy.origin`)
-   **[NEW]** Time Manipulation (`cy.clock`, `cy.tick`)

📘 **New to Cypress?** Check out the [Beginner's Guide](BEGINNER_GUIDE.md)!
